...
`,
  ...
  void main() {
    ...
    // Readjust the mouse coordinates
    vec2 mouse = Umouse * -.5;
    
    vec2 circlePos = st + mouse;
    float c = circle(circlePos, (Uradius / 1000.0), (Ublurriness / .1)) * 2.5;
    ...
    // Fix alpha
    float alpha = smoothstep(0.4, 1.0, finalImage.a);
    gl_FragColor = vec4(finalImage.r, finalImage.g, finalImage.b, alpha);
